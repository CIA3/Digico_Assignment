function calculate1(value){
	...
	document.getElementById('pq1').value = value;
...
function calculate2(value){
	...
	document.getElementById('pq2').value = value;
...
function calculate3(value){
	...
	document.getElementById('pq3').value = value;
...
function enableDisable1(chck){
	...
	document.getElementById('pq1').value = 0;
...
function enableDisable2(chck){
	...
	document.getElementById('pq2').value = 0;
...
function enableDisable3(chck){
	...
	document.getElementById('pq3').value = 0;
